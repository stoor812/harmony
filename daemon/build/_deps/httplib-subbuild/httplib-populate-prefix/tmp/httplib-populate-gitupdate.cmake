...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "v0.14.1"
  WORKING_DIRECTORY "/workspaces/harmony/daemon/build/_deps/httplib-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/harmony/daemon/build/_deps/httplib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/harmony/daemon/build/_deps/httplib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
